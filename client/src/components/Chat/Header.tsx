...
export default function Header() {
  ...
  return (
    <div className="via-presentation/70 md:from-presentation/80 md:via-presentation/50 2xl:from-presentation/0 absolute top-0 z-10 flex h-14 w-full items-center bg-gradient-to-b from-presentation to-transparent p-2 font-semibold text-text-primary 2xl:via-transparent">
      <div className="hide-scrollbar flex w-full min-w-0 items-center gap-3 overflow-x-auto">
        ...
        {/* Center: timestamp with reserved space to avoid overlapping left/right items */}
